...
type PatternRingsProps = SVGProps<SVGSVGElement>;
export const PatternRings = ({ ...props }: PatternRingsProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="530" height="129" {...props}>
